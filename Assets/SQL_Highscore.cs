...
{   
    private string secretKey= "$5$round(5000)$steamedhamsusername$";
    public string addScoreURL = "http://localhost/edugame/addscore.php";
    public string highscoreURL = "http://localhost/edugame/display.php";
